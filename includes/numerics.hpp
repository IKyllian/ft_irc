...
#define RPL_NONE(NULL)(NULL + "Undefined format" + "\n")																																													// 300
#define RPL_AWAY(nick, message)(" " + nick + " :" + message + "\n")																																							// 301
#define RPL_USERHOST(reply)(" :" + reply + "\n")																																												// 302
#define RPL_UNAWAY(NULL)(NULL + " :You are no longer marked as being away" + "\n")																																						// 305
#define RPL_NOWAWAY(NULL)(NULL + " :You have been marked as being away" + "\n")																																							// 306
...
#define RPL_ENDOFINVITELIST(NULL)(NULL + " :End of /INVITE list" + "\n")																																									// 337
//338 ???
...
#define RPL_ENDOFLINKS(NULL)(NULL + " * " + " :End of /LINKS list" + "\n")																																								// 365
...
#define RPL_ENDOFINFO(NULL)(NULL + " :End of INFO list" + "\n")																																											// 374
#define RPL_MOTDSTART(server)(" :- " + server + " Message of the day - " + "\n")																																				// 375
#define RPL_MOTD(motd)(" :" + motd + "\n")																																														// 372
#define RPL_ENDOFMOTD(NULL)(NULL + " :End of /MOTD command." + "\n")																																										// 376
...
#define RPL_YOUREOPER(NULL)(NULL + " :You are now an IRC operator" + "\n")																																								// 381
#define RPL_REHASHING(config_file)(" " + config_file + " :Rehashing" + "\n")																																					// 382
#define RPL_TIME(server, time)(" " + server + " :" + time + "\n")																																								// 391
#define RPL_STARTTLS(NULL)(NULL + " :STARTTLS successful, proceed with TLS handshake" + "\n")			//Ici																																	// 670									
...
#define RPL_SASLSUCCESS(NULL)(NULL + " :SASL authentication successful" + "\n")																																							// 903
...
#define ERR_WASNOSUCHNICK(NULL)(NULL + " :There was no such nickname" + "\n")																																								// 406		
#define ERR_NOORIGIN(NULL)(NULL + " :No origin specified" + "\n")																																											// 409
#define ERR_INPUTTOOLONG(NULL)(NULL + " :Input line was too long" + "\n")																																									// 417	
#define ERR_UNKNOWNCOMMAND(command)(" " + command + " :Unknown command" + "\n")																																				// 421							
#define ERR_NOMOTD(NULL)(NULL + " :MOTD File is missing" + "\n")																																											// 422
...
#define ERR_NOTREGISTERED(NULL)(NULL + " :You have not registered" + "\n")																																								// 451			
#define ERR_NEEDMOREPARAMS(command)(" " + command + " :Not enough parameters" + "\n")																																			// 461								
#define ERR_ALREADYREGISTERED(NULL)(NULL + " :You may not reregister" + "\n")																																						// 462					
#define ERR_PASSWDMISMATCH(NULL)(NULL + " :Password incorrect" + "\n")																																									// 464		
#define ERR_YOUREBANNEDCREEP(NULL)(NULL + " :You are banned from this server." + "\n")																																					// 465						
...
#define ERR_NOPRIVILEGES(NULL)(NULL + " :Permission Denied- You're not an IRC operator" + "\n")																																			// 481								
#define ERR_CHANOPRIVSNEEDED(channel)(" " + channel + " :You're not channel operator" + "\n")																																	// 482										
#define ERR_CANTKILLSERVER(NULL)(NULL + " :You cant kill a server!" + "\n")																																								// 483			
#define ERR_NOOPERHOST(NULL)(NULL + " :No O-lines for your host" + "\n")																																									// 491		
#define ERR_UMODEUNKNOWNFLAG(NULL)(NULL + " :Unknown MODE flag" + "\n")																																									// 501		
#define ERR_USERSDONTMATCH(NULL)(NULL + " :Cant change mode for other users" + "\n")																																						// 502					
...
#define ERR_STARTTLS(NULL)(NULL + " :STARTTLS failed (Wrong moon phase)" + "\n")																																					// 691						
...
#define ERR_NICKLOCKED(NULL)(NULL + " :You must use a nick assigned to you" + "\n")																																						// 902					
#define ERR_SASLFAIL(NULL)(NULL + " :SASL authentication failed" + "\n")																																									// 904		
#define ERR_SASLTOOLONG(NULL)(NULL + " :SASL message too long" + "\n")																																									// 905		
#define ERR_SASLABORTED(NULL)(NULL + " :SASL authentication aborted" + "\n")																																								// 906			
#define ERR_SASLALREADY(NULL)(NULL + " :You have already authenticated using SASL" + "\n")																																				// 907							
